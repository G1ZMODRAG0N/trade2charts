function Add-PieChartSeries
{
<#
    .SYNOPSIS
        Adds a pie chart Series to an existing ChartArea.
#>
    ...
    (
        ...
        [Parameter(ValueFromPipelineByPropertyName)]
        [System.Drawing.Color] $LineColor = [System.Drawing.Color]::FromName('Black'),
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUIsOSQrIwalRsDR+3ahCSsICh
# DXWggheaMIIFIzCCBAugAwIBAgIQAsbTxa4q6RSRmx0hkVyicTANBgkqhkiG9w0B
...
# NwIBFTAjBgkqhkiG9w0BCQQxFgQUvZhYDYovhMThv2RHpczy0oMgPa4wDQYJKoZI
# hvcNAQEBBQAEggEAKcUpWtYnsLxF8+cRZxHfrMLYH1TzCFW4VA/TS+f1yLXxCtEw
# 8/KMXmGfo/opF0o+qDIdM8OkgltbbEaWsFBpC1qkOWYS5MQiKhvy0KI4sOB0jV1r
# G1uRSmlTveKad4gdDAwkNuo0/0UFycOSm4pQTOenxKbA03UJkmhRoF9eqYgOD4to
# c/g1eIsjwP7e1/J5pMsmJauvJ6DiG7A3XUTQghY2d2nP4fHx3DidYPGmEXTKPeuj
# hch6HGDVzEjZoqkbnI9AcUEb63kwanCyM172I54a4opaF71d6bZe27juFyC7UUuj
# oI2JNrSvIo3Xm8HhJnkNVPOi4L57LlYU4Otpd6GCAg8wggILBgkqhkiG9w0BCQYx
...
# MTUzNDE3WjAjBgkqhkiG9w0BCQQxFgQU+1RZ5DoOcF+V2U+Hcs7kPSd97F4wDQYJ
# KoZIhvcNAQEBBQAEggEAa7dNU/oUZ1oqvbKA7n8bs2ymD6Unk6eXgH1xk+VxVKpx
# anxZLI69MumaGE00Tmam/HlC26DEO5ye2O/eFKaAo8jhVa/5rOwnkU2TiNVMA3ww
# 3AdKRt7Tk57MosCc1hPKArvKWXVdLyOi//jB++lSB4reKWnlCyMnHx6qhbXu41ep
# VQw0lkO98E0VP0g28gLDocsoZJgTbTAUaanO0mCIkuci0COxle+lBb/dPxGqt17M
# GXC2rJK9g+pQLpn+i6xZc/iYQ4xD4eCAC9A+tJJoBiBJfWk2+6DaiaPTXmmo8MDK
# d2/Na4iHAPyDa2JnTz2kC0IvoUUb9Qylui0UJvJ+rA==
